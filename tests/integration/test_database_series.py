...
class TestPublisherCRUD:
    ...
    def test_save_and_get(self, db_connection):
        from core.database import save_publisher, get_publisher
    ...
    def test_delete_publisher(self, db_connection):
        from core.database import save_publisher, delete_publisher, get_publisher
    ...
    def test_update_publisher_logo(self, db_connection):
        from core.database import save_publisher, update_publisher_logo, get_publisher
...
class TestPublisherFavorites:
    ...
    def test_set_favorite(self, db_connection):
        from core.database import save_publisher_path, set_publisher_favorite, is_favorite_publisher
    ...
    def test_get_favorites(self, db_connection):
        from core.database import save_publisher_path, set_publisher_favorite, get_favorite_publishers
...
class TestSeriesFavorites:
    ...
    def test_add_and_check(self, db_connection):
        from core.database import add_favorite_series, is_favorite_series

        add_favorite_series("/data/DC/Batman")
        assert is_favorite_series("/data/DC/Batman") is True

    def test_remove(self, db_connection):
        from core.database import add_favorite_series, remove_favorite_series, is_favorite_series
    ...
    def test_get_all(self, db_connection):
        from core.database import add_favorite_series, get_favorite_series
...
class TestSeriesMapping:
    ...
    def test_save_and_get(self, db_connection):
        from core.database import get_series_mapping, get_series_by_id
    ...
    def test_update_series_desc(self, db_connection):
        from core.database import update_series_desc, get_series_by_id
    ...
    def test_remove_series_mapping(self, db_connection):
        from core.database import remove_series_mapping, get_series_by_id
    ...
    def test_tracked_series_lookup(self, db_connection):
        from core.database import get_tracked_series_lookup
...
class TestIssueCRUD:
    ...
    def test_save_issues_bulk(self, db_connection):
        from core.database import save_issues_bulk, get_issues_for_series
    ...
    def test_delete_issues_for_series(self, db_connection):
        from core.database import delete_issues_for_series, get_issues_for_series
...
class TestCollectionStatus:
    ...
    def test_save_and_get(self, db_connection):
        from core.database import save_collection_status_bulk, get_collection_status_for_series
...
class TestWantedIssues:
    ...
    def test_clear_all(self, db_connection):
        from core.database import save_wanted_issues_for_series, clear_wanted_cache_all, get_cached_wanted_issues
...
class TestManualIssueStatus:
    ...
    def test_set_and_get(self, db_connection):
        from core.database import set_manual_status, get_manual_status_for_series
    ...
    def test_clear_status(self, db_connection):
        from core.database import set_manual_status, clear_manual_status, get_manual_status_for_series
    ...
    def test_bulk_set(self, db_connection):
        from core.database import bulk_set_manual_status, get_manual_status_for_series
