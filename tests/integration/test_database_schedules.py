...
class TestUnifiedSchedules:
    ...
    def test_save_schedule(self, db_connection):
        from core.database import save_schedule, get_schedule
    ...
    def test_update_last_run(self, db_connection):
        from core.database import update_schedule_last_run, get_schedule
...
class TestLegacySchedules:
    ...
    def test_get_rebuild_schedule(self, db_connection):
        from core.database import get_rebuild_schedule

        sched = get_rebuild_schedule()
        assert sched is not None

    def test_save_rebuild_schedule(self, db_connection):
        from core.database import save_rebuild_schedule, get_rebuild_schedule
    ...
    def test_sync_schedule(self, db_connection):
        from core.database import get_sync_schedule, save_sync_schedule
    ...
    def test_getcomics_schedule(self, db_connection):
        from core.database import get_getcomics_schedule, save_getcomics_schedule
...
class TestWeeklyPacks:
    ...
    def test_save_config(self, db_connection):
        from core.database import save_weekly_packs_config, get_weekly_packs_config
...
class TestBrowseCache:
    ...
    def test_save_and_get(self, db_connection):
        from core.database import save_browse_cache, get_browse_cache
    ...
    def test_invalidate(self, db_connection):
        from core.database import save_browse_cache, invalidate_browse_cache, get_browse_cache
    ...
    def test_clear_all(self, db_connection):
        from core.database import save_browse_cache, clear_browse_cache, get_browse_cache
...
class TestStatsCache:
    ...
    def test_save_and_get(self, db_connection):
        from core.database import save_cached_stats, get_cached_stats
    ...
    def test_clear_all(self, db_connection):
        from core.database import save_cached_stats, clear_stats_cache, get_cached_stats
    ...
    def test_clear_specific_keys(self, db_connection):
        from core.database import save_cached_stats, clear_stats_cache_keys, get_cached_stats
...
class TestReadingLists:
    ...
    def test_create_and_get(self, db_connection):
        from core.database import get_reading_lists
    ...
    def test_delete_list(self, db_connection):
        from core.database import delete_reading_list, get_reading_list
    ...
    def test_update_name(self, db_connection):
        from core.database import update_reading_list_name, get_reading_list
    ...
    def test_update_thumbnail(self, db_connection):
        from core.database import update_reading_list_thumbnail
    ...
    def test_tags(self, db_connection):
        from core.database import update_reading_list_tags, get_all_reading_list_tags
...
class TestLibraryCRUD:
    ...
    def test_add_and_get(self, db_connection):
        from core.database import add_library, get_libraries
    ...
    def test_get_by_id(self, db_connection):
        from core.database import add_library, get_library_by_id
    ...
    def test_update_library(self, db_connection):
        from core.database import add_library, update_library, get_library_by_id
    ...
    def test_delete_library(self, db_connection):
        from core.database import add_library, delete_library, get_library_by_id
